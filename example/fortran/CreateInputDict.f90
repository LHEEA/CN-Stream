...
WRITE(213,'(a)') '{'
WRITE(213,'(a,i,a1,a100)') 'GeneralDimension ',0,';','// Dimensional (=1) or Non-dimensional (=0)'
WRITE(213,'(a,e15.7,a1)') 'GeneralDepth',2*PI*prof/wavelength,';'
WRITE(213,'(a,i,a1,a100)') 'GeneralModes',20,';','//Number of modes for first evaluation'
...
WRITE(213,'(a,i,a1,a100)') 'CurrentType',0,';','// type of current ; 1 mass transport / 0 eulerian' !!ian current'
WRITE(213,'(a)') '}'
WRITE(213,'(a)') 'Options'
WRITE(213,'(a)') '{'
WRITE(213,'(a,i,a1,a100)') 'n_H ', 100,';','// Number of steps in wave height'
WRITE(213,'(a,i,a1,a100)') 'err_type ', 1,';','// Error type / 0 absolute ; 1 relative'
...
WRITE(213,'(a,i,a1,a100)') 'itermax  ', 999,';','// Maximum number of iterations'
WRITE(213,'(a,i,a1,a100)') 'increment_type ', 1,';','// Increment type for wave height / 0 linear ; 1 exp' !! onential'
WRITE(213,'(a,i,a1,a100)') 'printonscreen ', 1,';','// Print on screen =1 / do not print on screen = 0'
WRITE(213,'(a,i,a1,a100)') 'writeoutput ', 0,';','// Write output files =1 / do not Write output files = 0'
WRITE(213,*) '}'
